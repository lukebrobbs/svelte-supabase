...
<svelte:head>
	<title>SupaSvelte - Sign up</title>
</svelte:head>
...
<div class="flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
	<div class="max-w-md w-full space-y-8">
		<div>
			...
			<h2 class="mt-2 text-center text-3xl font-extrabold text-gray-900">Sign up for an account</h2>
			<p class="mt-2 text-center text-sm text-gray-600">
				Or
				<a href="/sign-in" class="font-medium text-primary-500 hover:text-primary-700"> Sign in </a>
			</p>
		</div>
